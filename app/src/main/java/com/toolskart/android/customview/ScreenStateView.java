 ...
 * the {@link ScreenStateView.ViewState} accordingly
 * Every ScreenStateView <b><i>MUST</i></b> contain a content navigationView. The content navigationView
 * is obtained from whatever is inside of the tags of the navigationView via its XML declaration
 */
public class ScreenStateView extends FrameLayout {
    ...
    public static final int VIEW_STATE_EMPTY_BANK = 5;
    ...
    public ScreenStateView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (mContentView == null)
            throw new IllegalArgumentException("Content navigationView is not defined");
        setView(VIEW_STATE_UNKNOWN);
    }

    /* All of the addView methods have been overridden so that it can obtain the content navigationView via XML
    ...
    /**
     * Returns the {@link View} associated with the {@link ScreenStateView.ViewState}
     *
     * @param state The {@link ScreenStateView.ViewState} with to return the navigationView for
     * @return The {@link View} associated with the {@link ScreenStateView.ViewState}, null if no navigationView is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link ScreenStateView.ViewState}
     *
     * @return
     */
    @ViewState
    ...
    /**
     * Sets the current {@link ScreenStateView.ViewState}
     *
     * @param state The {@link ScreenStateView.ViewState} to set {@link ScreenStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link ScreenStateView.ViewState}
     */
    private void setView(@ViewState int previousState) {
        switch (mViewState) {
            ...
            default:
                if (mContentView == null) {
                    // Should never happen, the navigationView should throw an exception if no content navigationView is present upon creation
    ...
    /**
     * Sets the navigationView for the given navigationView state
     *
     * @param view          The {@link View} to use
     * @param state         The {@link ScreenStateView.ViewState}to set
     * @param switchToState If the {@link ScreenStateView.ViewState} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link ScreenStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link ScreenStateView.ViewState} to set
     */
     ...
     *
     * @param previousView The navigationView that it was currently on
     */
